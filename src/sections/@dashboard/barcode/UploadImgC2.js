...

            {
                load && json && <Grid item container rowSpacing={3} columnSpacing={3} sx={{ marginTop: '3%' }} > <Grid item md={8}>
                    ...
                    <Grid item md={4}>
                        ...
                        <Alert sx={{ cursor: 'pointer' }} onClick={() => open3(json.blacklist)} severity="error"> Suspected IP address <strong>{json.sus_ip}</strong> Port:<strong>{json.sus_port}</strong> </Alert>
                        {editSinglePerson && <>
