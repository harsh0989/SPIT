...

            {
                load && json && <Grid item container rowSpacing={3} columnSpacing={3} sx={{ marginTop: '3%' }} > <Grid item md={8}>
                    ...
                    <Grid item md={4}>
                        ...
                        <Alert sx={{ cursor: 'pointer' }} onClick={() => open3(json.all_ips[1])} severity="error"> Suspected IP address <strong>{json.all_ips[1]}</strong></Alert>
                        {editSinglePerson && <>
